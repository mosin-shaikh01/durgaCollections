<?php
/**
 * Plugin Name:          Durga Product Codes
 ...
 * Text Domain:          durga-product-codes
...
spl_autoload_register(
	static function ( $class_name ) {
		...
		$file = DPC_PLUGIN_DIR . 'includes/' . str_replace( '\\', '/', $relative ) . '.php';
...
register_activation_hook( __FILE__, array( 'Durga\\ProductCodes\\Install', 'activate' ) );
register_deactivation_hook( __FILE__, array( 'Durga\\ProductCodes\\Install', 'deactivate' ) );
...
add_action(
	...
	static function () {
		if ( class_exists( \Automattic\WooCommerce\Utilities\FeaturesUtil::class ) ) {
			\Automattic\WooCommerce\Utilities\FeaturesUtil::declare_compatibility( 'custom_order_tables', DPC_PLUGIN_FILE, true );
		}
	}
);

// Boot after all plugins are loaded: this file loads before WooCommerce alphabetically.
add_action( 'plugins_loaded', array( 'Durga\\ProductCodes\\Plugin', 'boot' ) );
