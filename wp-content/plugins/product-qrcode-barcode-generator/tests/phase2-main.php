...
pqbg_t( 'shop_manager has NO pqbg_manage_settings', ! $sm->has_cap( 'pqbg_manage_settings' ) );
pqbg_t( 'administrator has all 7 pqbg caps', 7 === count( $pqbg( $ad ) ) && $ad->has_cap( 'pqbg_manage_settings' ), implode( ',', $pqbg( $ad ) ) );
$others = true;
