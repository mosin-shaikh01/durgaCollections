...
class TypeCode93 implements TypeInterface
{
    ...
    public function getBarcode(string $code): Barcode
    {
        ...
        $barcode->addBar(new BarcodeBar(1, 1, \true));
        return $barcode;
    }
    /**
