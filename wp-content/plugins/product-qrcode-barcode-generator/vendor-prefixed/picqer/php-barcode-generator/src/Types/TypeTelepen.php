...
class TypeTelepen implements TypeInterface
{
    ...
    private function encodeNumeric(string $code): string
    {
        ...
        $count = 0;
        $dest = $this->telepen_lookup_table[ord(self::TELEPEN_START_CHAR)];
        // begin with the start character _
