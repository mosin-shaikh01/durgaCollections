...
namespace ProductQrBarcode\Vendor\BaconQrCode\Encoder;

defined( 'ABSPATH' ) || exit;

use ProductQrBarcode\Vendor\BaconQrCode\Common\BitArray;
use ProductQrBarcode\Vendor\BaconQrCode\Common\CharacterSetEci;
use ProductQrBarcode\Vendor\BaconQrCode\Common\ErrorCorrectionLevel;
use ProductQrBarcode\Vendor\BaconQrCode\Common\Mode;
use ProductQrBarcode\Vendor\BaconQrCode\Common\ReedSolomonCodec;
use ProductQrBarcode\Vendor\BaconQrCode\Common\Version;
use ProductQrBarcode\Vendor\BaconQrCode\Exception\WriterException;
use SplFixedArray;
/**
 * Encoder.
 */
