...
final class EllipticArc implements OperationInterface
{
    ...
    public function __construct(float $xRadius, float $yRadius, float $xAxisAngle, private readonly bool $largeArc, private readonly bool $sweep, private readonly float $x, private readonly float $y)
    {
    ...
    public function rotate(int $degrees): OperationInterface
    {
        ...
        return new self($this->xRadius, $this->yRadius, $this->xAxisAngle, $this->largeArc, $this->sweep, $xr, $yr);
    }
    /**
