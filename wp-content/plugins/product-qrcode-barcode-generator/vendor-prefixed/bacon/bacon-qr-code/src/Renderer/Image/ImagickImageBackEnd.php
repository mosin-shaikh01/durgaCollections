...
namespace ProductQrBarcode\Vendor\BaconQrCode\Renderer\Image;
...
use ProductQrBarcode\Vendor\BaconQrCode\Renderer\Color\Cmyk;
use ProductQrBarcode\Vendor\BaconQrCode\Renderer\Color\ColorInterface;
use ProductQrBarcode\Vendor\BaconQrCode\Renderer\Color\Gray;
use ProductQrBarcode\Vendor\BaconQrCode\Renderer\Color\Rgb;
use ProductQrBarcode\Vendor\BaconQrCode\Renderer\Path\Close;
use ProductQrBarcode\Vendor\BaconQrCode\Renderer\Path\Curve;
use ProductQrBarcode\Vendor\BaconQrCode\Renderer\Path\EllipticArc;
use ProductQrBarcode\Vendor\BaconQrCode\Renderer\Path\Line;
use ProductQrBarcode\Vendor\BaconQrCode\Renderer\Path\Move;
use ProductQrBarcode\Vendor\BaconQrCode\Renderer\Path\Path;
use ProductQrBarcode\Vendor\BaconQrCode\Renderer\RendererStyle\Gradient;
use ProductQrBarcode\Vendor\BaconQrCode\Renderer\RendererStyle\GradientType;
use Imagick;
use ImagickDraw;
use ImagickPixel;
