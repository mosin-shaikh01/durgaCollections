...
namespace ProductQrBarcode\Vendor\BaconQrCode\Common;

defined( 'ABSPATH' ) || exit;

use ProductQrBarcode\Vendor\DASPRiD\Enum\AbstractEnum;
/**
...
final class Mode extends AbstractEnum
{
     ...
     */
    protected function __construct(private readonly array $characterCountBitsForVersions, private readonly int $bits)
    {
    }
    /**
